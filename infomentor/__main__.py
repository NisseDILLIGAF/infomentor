...
import json
# import configparser
from infomentor import connector
...
def logtofile():
    ...
    handler = RotatingFileHandler("/home/appuser/log.txt", maxBytes=1024 * 1024, backupCount=10)
    logging.basicConfig(
